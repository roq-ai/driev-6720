...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Bike', path: '/bikes', entity: 'bike', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Booking', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Rate', path: '/rates', entity: 'rate', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
